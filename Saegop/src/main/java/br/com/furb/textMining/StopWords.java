...
public class StopWords {
	...
	private static String[] s_stopWords = { "o", "a", "os", "as", "um", "uma", "uns", "umas",
			...
			"demais",  "que",  "quão",  "quanto",  "quase",  "como",  "abaixo",  "acima",  "acol�",  "cá", 
			"lá",  "aqui",  "ali",  "aé",  "além",  "aquém",  "algures",  "alhures",  "nenhures",  "atrás", 
			...
			"hoje",  "amanhã",  "depois",  "ontem",  "anteontem",  "jã",  "sempre",  "ami�de", 
